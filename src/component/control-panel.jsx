...
export const ControlPanel = ({
  ...
  const [setHelpModalStatus, setSetHelpModalStatus] = useState(false);

  return (
    <>
      <SetHelpModal
        modalStatus={setHelpModalStatus}
        setModalStatus={setSetHelpModalStatus}
        ...
        <div className="scrollable-part">
          ...
          <div>
            ...
            <div>
              ...
              <Button
                type={
                  studentSortedBy === "release date" ? "primary" : "default"
                }
                onClick={() => {
          ...
          <div>
            <span>
              ...
              <button
                className="set-help-btn"
                onClick={() => {
                  setSetHelpModalStatus(true);
                }}
              >
